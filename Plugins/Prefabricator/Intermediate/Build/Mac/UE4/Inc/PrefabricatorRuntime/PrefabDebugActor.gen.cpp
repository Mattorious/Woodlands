...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_APrefabDebugActor_Statics::NewProp_ActorData = { "ActorData", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APrefabDebugActor, ActorData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_APrefabDebugActor_Statics::NewProp_ActorData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APrefabDebugActor_Statics::NewProp_ActorData_MetaData)) };
	...
	IMPLEMENT_CLASS(APrefabDebugActor, 3480251584);
