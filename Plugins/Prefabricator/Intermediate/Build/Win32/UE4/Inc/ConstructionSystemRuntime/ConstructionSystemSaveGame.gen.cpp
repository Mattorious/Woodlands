...
static struct FScriptStruct_ConstructionSystemRuntime_StaticRegisterNativesFConstructionSystemSaveConstructedItem
{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UConstructionSystemSaveGame_Statics::NewProp_ConstructedItems = { "ConstructedItems", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConstructionSystemSaveGame, ConstructedItems), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UConstructionSystemSaveGame_Statics::NewProp_ConstructedItems_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConstructionSystemSaveGame_Statics::NewProp_ConstructedItems_MetaData)) };
	...
	IMPLEMENT_CLASS(UConstructionSystemSaveGame, 555167122);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UConstructionSystemSaveSystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UConstructionSystemSaveSystem_HandleConstructionSystemLevelLoad, "HandleConstructionSystemLevelLoad" }, // 3340101959
		{ &Z_Construct_UFunction_UConstructionSystemSaveSystem_LoadConstructionSystemLevel, "LoadConstructionSystemLevel" }, // 3864966618
		{ &Z_Construct_UFunction_UConstructionSystemSaveSystem_SaveConstructionSystemLevel, "SaveConstructionSystemLevel" }, // 50906104
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UConstructionSystemSaveSystem, 227769549);
