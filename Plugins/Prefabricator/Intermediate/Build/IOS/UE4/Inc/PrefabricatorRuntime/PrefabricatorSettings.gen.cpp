...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_IgnoreBoundingBoxForObjects_MetaData[];
#endif
		static const UE4CodeGen_Private::FSetPropertyParams NewProp_IgnoreBoundingBoxForObjects;
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_IgnoreBoundingBoxForObjects_ElementProp;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPrefabricatorSettings_Statics::NewProp_IgnoreBoundingBoxForObjects_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FSetPropertyParams Z_Construct_UClass_UPrefabricatorSettings_Statics::NewProp_IgnoreBoundingBoxForObjects = { "IgnoreBoundingBoxForObjects", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPrefabricatorSettings, IgnoreBoundingBoxForObjects), METADATA_PARAMS(Z_Construct_UClass_UPrefabricatorSettings_Statics::NewProp_IgnoreBoundingBoxForObjects_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPrefabricatorSettings_Statics::NewProp_IgnoreBoundingBoxForObjects_MetaData)) };
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_UPrefabricatorSettings_Statics::NewProp_IgnoreBoundingBoxForObjects_ElementProp = { "IgnoreBoundingBoxForObjects", nullptr, (EPropertyFlags)0x0000000000004001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPrefabricatorSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPrefabricatorSettings_Statics::NewProp_IgnoreBoundingBoxForObjects,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPrefabricatorSettings_Statics::NewProp_IgnoreBoundingBoxForObjects_ElementProp,
	...
	IMPLEMENT_CLASS(UPrefabricatorSettings, 2372086768);
