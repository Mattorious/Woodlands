...
#include "Voxel/Public/VoxelCoordinatesProvider.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeVoxelCoordinatesProvider() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Voxel_EVoxelWorldCoordinatesRounding_Hash() { return 1769775440U; }
	UEnum* Z_Construct_UEnum_Voxel_EVoxelWorldCoordinatesRounding()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "ModuleRelativePath", "Public/VoxelCoordinatesProvider.h" },
