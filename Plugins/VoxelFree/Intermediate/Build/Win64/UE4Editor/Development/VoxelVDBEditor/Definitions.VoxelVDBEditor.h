...
#define UE_TARGET_NAME WoodlandsEditor
...
#define VOXELVDB_API DLLIMPORT
#define OPENVDB_STATICLIB 1
#define OPENVDB_OPENEXR_STATICLIB 1
#define OPENVDB_2_ABI_COMPATIBLE 1
#define DESKTOPPLATFORM_API DLLIMPORT
#define VOXELVDBEDITOR_API DLLEXPORT
