...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVoxelAssetPickerNode_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UVoxelAssetPickerNode_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UVoxelAssetPickerNode()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UVoxelAssetPickerNode_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UVoxelAssetPickerNode, 1800128062);
	template<> VOXELGRAPH_API UClass* StaticClass<UVoxelAssetPickerNode>()
	{
		return UVoxelAssetPickerNode::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UVoxelAssetPickerNode(Z_Construct_UClass_UVoxelAssetPickerNode, &UVoxelAssetPickerNode::StaticClass, TEXT("/Script/VoxelGraph"), TEXT("UVoxelAssetPickerNode"), false, nullptr, nullptr, nullptr);
