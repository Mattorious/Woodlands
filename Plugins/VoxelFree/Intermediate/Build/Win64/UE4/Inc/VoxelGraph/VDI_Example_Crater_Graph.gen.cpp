...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVDI_Example_Crater_Graph_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UVDI_Example_Crater_Graph_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UVDI_Example_Crater_Graph()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UVDI_Example_Crater_Graph_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UVDI_Example_Crater_Graph, 2629794043);
	template<> VOXELGRAPH_API UClass* StaticClass<UVDI_Example_Crater_Graph>()
	{
		return UVDI_Example_Crater_Graph::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UVDI_Example_Crater_Graph(Z_Construct_UClass_UVDI_Example_Crater_Graph, &UVDI_Example_Crater_Graph::StaticClass, TEXT("/Script/VoxelGraph"), TEXT("UVDI_Example_Crater_Graph"), false, nullptr, nullptr, nullptr);
