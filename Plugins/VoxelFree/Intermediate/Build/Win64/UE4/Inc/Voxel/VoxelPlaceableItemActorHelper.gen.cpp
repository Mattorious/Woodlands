...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVoxelPlaceableItemActorHelper_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UVoxelPlaceableItemActorHelper_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UVoxelPlaceableItemActorHelper()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UVoxelPlaceableItemActorHelper_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UVoxelPlaceableItemActorHelper, 2701865875);
	template<> VOXEL_API UClass* StaticClass<UVoxelPlaceableItemActorHelper>()
	{
		return UVoxelPlaceableItemActorHelper::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UVoxelPlaceableItemActorHelper(Z_Construct_UClass_UVoxelPlaceableItemActorHelper, &UVoxelPlaceableItemActorHelper::StaticClass, TEXT("/Script/Voxel"), TEXT("UVoxelPlaceableItemActorHelper"), false, nullptr, nullptr, nullptr);
